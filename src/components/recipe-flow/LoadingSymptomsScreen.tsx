  ...
  const loadingStepConfigs: LoadingStepConfig[] = [
    ...
    },
    {
      ...
      text: (data) => {
        ...
        const displayCauses = causeNames ? `${causeNames}${remainingCount > 0 ? ` e mais ${remainingCount}` : ''}` : 'N/A';
    ...
    {
      id: 'search_symptoms',
      text: () => "Buscando Sintomas Potenciais...",
      duration: 3500,
    },
    {
      id: 'correlate_symptoms',
      text: () => "Correlacionando Sintomas com Causas...",
      duration: 2500,
    },
    {
      id: 'finalize_symptom_list',
      text: () => "Finalizando Lista de Sintomas...",
      duration: 1000,
    },
  ];
...
export default LoadingSymptomsScreen;
